...
#define FLOWLET_WIDTH 16
#define FLOW_WIDTH 13
#define FLOW_SIZE 8192
#define TIME_GAP 50000

header_type ingress_metadata_t {
    fields {
        ecmp_offset : 14; // offset into the ecmp table
        nhop_ipv4 : 32;
        flowlet_id : FLOWLET_WIDTH;
        flow_offset : FLOW_WIDTH;
        last_time : 32;
        ipg : 32; // inter-packet gap
    }
}
...
action update_flowlet() {
    register_write(flowlet_ids, ingress_metadata.flow_offset, 
