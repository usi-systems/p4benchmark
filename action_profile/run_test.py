...
parser.add_argument('--random-src',
                    help='Use a random source IP address for each packet',
...
queue.add_iface("veth6")
queue.add_iface("veth8")
...
for d in delays:
    ...
    if args.random_src:
        pkt["IP"].src = "10.0.0.%d" % random.randint(2, 255)
